...
def gerar_laudo(card):
    ...
    laudo.multi_cell(0, line_height, f'**CONSUMIDOR FINAL (RECLAMANTE):** Sr.(a). {card["UF_CRM_1727967417706"]}, portador do CPF n° {card["UF_CRM_1727204145431"]}, residente na {card["UF_CRM_1727204166054"]}, {card["UF_CRM_1728049409"]}, {card["UF_CRM_1727978206065"]}, {card["UF_CRM_1727978359495"].strip()} - {estado_correspondente(card["UF_CRM_1727977680889"])}.', 0, "J", markdown=True, ln=1)
